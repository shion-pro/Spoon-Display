        ...
        function Main_Paper() {
            ...
            this.draw = function () {
                ...
                for (var i = 0; i < paperListLength; i++) {
                    ...
                    // _this.context2d.quadraticCurveTo(paper.x, paper.x, paper.x + paper.y / 4, paper.x);
                    // _this.context2d.quadraticCurveTo(paper.x + paper.y / 2, paper.x, paper.x + paper.y / 2, paper.x + paper.y / 4);
                    // _this.context2d.quadraticCurveTo(paper.x + paper.y / 2, paper.x, paper.x + paper.y * 3/4, paper.x);
                    // _this.context2d.quadraticCurveTo(paper.x + paper.y, paper.x, paper.x + paper.y, paper.x + paper.y / 4);
                    // _this.context2d.quadraticCurveTo(paper.x + paper.y, paper.x + paper.y / 2, paper.x + paper.y * 3/4, paper.x + paper.y * 3/4);
                    // _this.context2d.lineTo(paper.x + paper.y / 2, paper.x + paper.y);
                    // _this.context2d.lineTo(paper.x + paper.y / 4, paper.x + paper.y * 3/4);
                    // _this.context2d.quadraticCurveTo(paper.x, paper.x + paper.y / 2, paper.x, paper.x + paper.y / 4);
